...
using h5gt::Attribute;
using h5gt::AtomicType;
using h5gt::DataSet;
using h5gt::DataSetCreateProps;
using h5gt::DataSpace;
using h5gt::Exception;
using h5gt::File;
using h5gt::ObjectType;
using h5gt::LinkCreateProps;
using h5gt::LinkAccessProps;
