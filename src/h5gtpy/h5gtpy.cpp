...
//  PY_CLASS_DEF_t(pySliceTraits_Selection, write, {"write"}, py_types);
//  PY_CLASS_DEF_t(pySliceTraits_Dset, write, {"write"}, py_types);
//  PY_CLASS_DEF_t(pySliceTraits_Selection, write, {"write"}, py_list_types);
//  PY_CLASS_DEF_t(pySliceTraits_Dset, write, {"write"}, py_list_types);
//  PY_CLASS_DEF_t(pySliceTraits_Selection, write, {"write"}, eigen_types);
//  PY_CLASS_DEF_t(pySliceTraits_Dset, write, {"write"}, eigen_types);

//  PY_CLASS_DEF_ext_t(pySliceTraits_Selection, write_eigen_raw, {"write_raw"}, numpy_types);
//  PY_CLASS_DEF_ext_t(pySliceTraits_Dset, write_eigen_raw, {"write_raw"}, numpy_types);
...
//  PY_CLASS_DEF_t(pySliceTraits_Selection, read_eigen, read_eigen_names, numpy_types);
//  PY_CLASS_DEF_t(pySliceTraits_Dset, read_eigen, read_eigen_names, numpy_types);

  // в SliceTraits<> надо добавить метод возвращающий питон лист стринг
