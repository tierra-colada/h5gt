...
// Tell h5gt how to create the HDF5 datatype for this base type by
// using the H5GT_REGISTER_TYPE macro
CompoundType create_compound_csl() {
    return {{"u1", AtomicType<unsigned char>{}},
            {"u2", AtomicType<short>{}},
            {"u3", AtomicType<unsigned long long>{}}};
}
H5GT_REGISTER_TYPE(csl, create_compound_csl)
...
int main(void) {
    ...
    try {
        ...
        // implementation of h5gt::create_datatype above
